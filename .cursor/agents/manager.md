...
派发、验收、质检、版本计划收口时，须遵守专条：[`.cursor/agents/GOVERNANCE-权威基线与可验证一致性.md`](./GOVERNANCE-权威基线与可验证一致性.md)。
...
| 视觉设计师 | `vd` | 视觉系统与 Token、层级与可读性、深浅色与资源规格、视觉走查 |
